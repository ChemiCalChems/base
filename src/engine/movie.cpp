...
struct aviwriter
{
    ...
    bool open()
    {
        ...
        listchunk("LIST", "INFO");
        const char *software = versionfname;
...
namespace recorder
{
    ...
    void drawhud()
    {
        ...
        draw_textf("recorded %.1f%s %d%%", w*3-FONTH*3/2, FONTH*3/2, 0, 0, -1, -1, -1, 255, TEXT_RIGHT_JUSTIFY, -1, -1, 1, totalsize, unit, int(calcquality()*100));
